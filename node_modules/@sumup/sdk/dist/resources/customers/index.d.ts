...
export declare class Customers extends Core.APIResource {
    /**
     * Create a customer
     */
     ...
     * Retrieve a customer
     */
    get(customerId: string, params?: Core.FetchParams): Core.APIPromise<Customer>;
    /**
     * Update a customer
     */
    update(customerId: string, body: UpdateCustomerParams, params?: Core.FetchParams): Core.APIPromise<Customer>;
    /**
     * List payment instruments
     */
    listPaymentInstruments(customerId: string, params?: Core.FetchParams): Core.APIPromise<PaymentInstrumentResponse[]>;
    /**
     * Deactivate a payment instrument
     */
    deactivatePaymentInstrument(customerId: string, token: string, params?: Core.FetchParams): Core.APIPromise<void>;
}
export declare namespace Customers {
    export type { Address, Customer, ErrorForbidden, MandateResponse, PaymentInstrumentResponse, PersonalDetails, UpdateCustomerParams, };
}
